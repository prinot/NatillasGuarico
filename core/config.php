...
# Seguridad
defined('INDEX_DIR') OR exit('Prinot S.A. says  creias que ibas a pasar te falta odiar mas ForceVenezuela.i.');
...
define('DATABASE', array(
  ...
  'user' => 'root',
  'pass' => '',
  'name' => 'natillasguarico',
  //comentado   'port' => 1521,
  //comentado   'protocol' => 'TCP',
  'motor' => 'mysql'
));
...
define('URL', 'http://localhost/natillasguarico/');
define('APP', 'Prinot S.A.');
...
*/
define('__ROOT__', '/natillasguarico/');
